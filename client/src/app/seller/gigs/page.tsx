  ...
  return (
    <div className="relative min-h-screen bg-[#090a10] py-20 px-2 overflow-hidden">
      ...
      <main className="relative z-10 max-w-6xl mx-auto">
        ...
        {gigs.length === 0 && (
          <div className="text-center text-blue-300 text-lg mt-16">
            ...
            >
              ...
              <div>
                ...
                <div className="font-bold text-blue-400 text-lg mb-1">
                  ${((gig.price_cents ?? 0) / 100).toFixed(2)}
                </div>
                <div className="text-xs text-blue-500 mb-2">
                  Delivery: {gig.delivery_time_days} day(s)
                </div>

                <div className="flex gap-2">
                  {/* OPEN THE PUBLIC SERVICE PAGE */}
                  <Link
                  ...
                  {/* Keep the edit link to seller edit page */}
                  <Link
