  ...
  return (
    <main className="relative min-h-screen bg-[#070D1C] text-slate-100 overflow-x-hidden pt-24 md:pt-28">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-#35BFFF/20 rounded-full blur-[120px]" />
        <div className="absolute -bottom-32 -right-24 w-[28rem] h-[28rem] bg-#2A9FE6/20 rounded-full blur-[120px]" />
      </div>
            ...
            <div className="flex flex-wrap gap-4 mb-12 p-6 bg-[#0D1328] rounded-2xl shadow-2xl border border-slate-700/60">
              <Link
                ...
                className={`flex-1 min-w-[200px] px-8 py-4 rounded-xl text-center font-bold text-lg shadow-xl transition transform hover:scale-[1.01] active:scale-[0.99] ${
                  gig ? 'bg-[#35BFFF] text-white shadow-[#35BFFF]/40 hover:bg-#35BFFF' : 'bg-gray-600 cursor-not-allowed'
                }`}
                role="button"
                aria-disabled={!gig}
              >
              ...
              <div className="bg-[#0D1328] rounded-2xl shadow-2xl border border-[#35BFFF]/50 p-6">
                ...
                <Link
                  ...
                  className={`w-full block text-center px-6 py-3.5 rounded-xl font-bold text-lg transition transform hover:scale-[1.01] active:scale-[0.99] ${
                    gig ? 'bg-[#35BFFF] text-white shadow-xl shadow-[#35BFFF]/40 hover:bg-#35BFFF' : 'bg-gray-600 cursor-not-allowed text-white'
                  }`}
                  role="button"
                  aria-disabled={!gig}
                >
          ...
          <div className="w-full max-w-lg bg-[#0D1328] border border-slate-700/60 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="mt-5 flex items-center justify-between">
              <a
                ...
                className="text-#35BFFF hover:text-#5DD0FF text-sm underline underline-offset-2"
                target="_blank"
                rel="noreferrer"
