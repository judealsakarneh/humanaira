...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 py-20 w-full min-h-[calc(100vh-72px)] max-w-full overflow-hidden">
        <h1
          className="mb-2 leading-tight tracking-tight drop-shadow-xl font-extrabold text-white max-w-full"
          style={{
        ...
        >
          ...
          <span
            style={{
              ...
              color: '#38bdf8',
              fontWeight: 500,
              fontSize: 'clamp(1.5rem, 7vw, 5.2rem)',
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-start md:justify-between gap-12">
        <div className="flex flex-col items-start gap-3">
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <a
              href="https://www.instagram.com/humanaira"
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-sky-400 transition-colors duration-200"
